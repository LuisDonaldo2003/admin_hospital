      ...
      menu: [
        {
          ...
          group: 'GRUPO_ADMINISTRADOR', // <--- NUEVO
          hasSubRoute: true,
          showSubRoute: false,
          base: 'gallery',
          base2: 'profile',
        ...
        {
          menuValue: 'SIDEBAR_PHARMACY',
          group: 'GRUPO_PHARMACY',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'pharmacy',
          icon: 'fas fa-pills',
          ...
          subMenus: [
            {
              menuValue: 'SIDEBAR_PHARMACY_ADD',
              route: routes.addAntibiotics,
              base: routes.addAntibiotics,
              permision: 'add_antibiotics',
              show_nav: true,
            },
            {
              menuValue: 'SIDEBAR_PHARMACY_LIST',
              route: routes.antibioticsList,
              base: routes.antibioticsList,
              permision: 'list_antibiotics',
              show_nav: true,
            },
            {
              menuValue: 'SIDEBAR_PHARMACY_EDIT',
              route: '',
              base: '',
              permision: 'edit_antibiotics',
              show_nav: false,
            },
            {
              menuValue: 'SIDEBAR_PHARMACY_DELETE',
              route: '',
              base: '',
              permision: 'delete_antibiotics',
              show_nav: false,
            },
          ],
        },
        {
          menuValue: 'SIDEBAR_PHARMACY_INVENTORY',
          group: 'GRUPO_PHARMACY',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'pharmacy',

      ...
      menu: [
        {
          ...
          subMenus: [
            ...
            },
            {
              ...
              permision: 'user_activity_dashboard',
              show_nav: true,
            },
          ],
        },
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'LIST',
              route: routes.roleFamiliesList,
              base: routes.roleFamiliesList,
              permision: 'list_role_family',
              show_nav: true,
            },
            {
              menuValue: 'ADD',
              route: routes.addRoleFamily,
              base: routes.addRoleFamily,
              permision: 'register_role_family',
              show_nav: true,
            },
            {
              menuValue: 'ASSIGN',
              route: routes.assignRolesRoleFamily,
              base: routes.assignRolesRoleFamily,
              permision: 'edit_role_family',
              show_nav: true,
            },
            {
              menuValue: 'EDIT',
        ...
        {
          menuValue: 'PDF_COMPRESSOR',
          group: 'GRUPO_RH',
          hasSubRoute: false,
          showSubRoute: false,
          route: routes.pdfCompressor,
          base: 'pdf-compressor',
          icon: 'fas fa-compress',
          faIcon: true,
          permision: 'access_pdf_compressor',
          show_nav: true,
          subMenus: [],
        },
        {
          menuValue: 'ASSISTANTS',
          group: 'GRUPO_ENSEÑANZA',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'teaching',
          ...
          subMenus: [
            {
              menuValue: 'LIST',
              route: routes.assistantsList,
              base: routes.assistantsList,
              permision: 'list_teaching',
              show_nav: true,
            },
            {
              menuValue: 'ADD',
              route: routes.addAssistant,
              base: routes.addAssistant,
              permision: 'add_teaching',
              show_nav: true,
            },
            {
              menuValue: 'EDIT',
            ...
            },
            {
              ...
              route: '',
              base: '',
              permision: 'delete_teaching',
              show_nav: false,
            },
          ],
        },
        {
          menuValue: 'EVALUATIONS',
          group: 'GRUPO_ENSEÑANZA',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'teaching',
          ...
          subMenus: [
            {
              menuValue: 'ADD',
              route: routes.addEvaluation,
              base: routes.addEvaluation,
              permision: 'add_evaluation',
              show_nav: true,
            },
            {
              menuValue: 'LIST',
              route: routes.evaluations,
              base: routes.evaluations,
              permision: 'list_evaluation',
              show_nav: true,
            },
            {
              menuValue: 'EDIT',
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'LIST',
              route: routes.modalities,
              base: routes.modalities,
              permision: 'list_modality',
              show_nav: true,
            },
            {
              menuValue: 'ADD',
              route: routes.addModality,
              base: routes.addModality,
              permision: 'add_modality',
              show_nav: true,
            },
            {
              menuValue: 'EDIT',
            ...
            },
            {
              ...
              route: '',
              base: '',
              permision: 'delete_modality',
              show_nav: false,
            },
          ],
        },
        {
          menuValue: 'STAKEHOLDINGS',
          group: 'GRUPO_ENSEÑANZA',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'teaching',
          ...
          subMenus: [
            {
              menuValue: 'LIST',
              route: routes.stakeholdings,
              base: routes.stakeholdings,
              permision: 'list_stakeholding',
              show_nav: true,
            },
            {
              menuValue: 'ADD',
              route: routes.addStakeholding,
              base: routes.addStakeholding,
              permision: 'add_stakeholding',
              show_nav: true,
            },
            {
              menuValue: 'EDIT',
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'LIST',
              route: routes.teachingAreas,
              base: routes.teachingAreas,
              permision: 'list_area',
              show_nav: true,
            },
            {
              menuValue: 'ADD',
              route: routes.addArea,
              base: routes.addArea,
              permision: 'add_area',
              show_nav: true,
            },
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'ADD',
              route: routes.addAppointments,
              base: routes.addAppointments,
              permision: 'add_appointment',
              show_nav: true,
            },
            {
              menuValue: 'LIST',
              route: routes.appointmentsList,
              base: routes.appointmentsList,
              permision: 'list_appointments',
              show_nav: true,
            },
            {
              menuValue: 'CANCELLED',
              route: routes.cancelledAppointments,
              base: routes.cancelledAppointments,
              permision: 'list_appointments',
              show_nav: true,
            },
            {
              menuValue: 'COMPLETED',
              route: routes.completedAppointments,
              base: routes.completedAppointments,
              permision: 'list_appointments',
              show_nav: true,
            },
            {
              menuValue: 'NO_SHOW',
              route: routes.noShowAppointments,
              base: routes.noShowAppointments,
              permision: 'list_appointments',
              show_nav: true,
            },
            {
        ...
        },
        {
          ...
          hasSubRoute: false,
          showSubRoute: false,
          route: routes.appointmentsCalendar,
          base: 'appointments-calendar',
          icon: 'fas fa-compress',
          faIcon: true,
          permision: 'access_appointments_calendar',
          show_nav: true,
          subMenus: [],
        },
        {
          ...
          subMenus: [
            {
              ...
              permision: 'list_doctors',
              show_nav: true,
            },
            {
              menuValue: 'ADD',
              route: routes.addDoctors,
              base: routes.addDoctors,
              permision: 'add_doctor',
              show_nav: true,
            },
            {
              menuValue: 'EDIT',
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'LIST',
              route: routes.especialidadesList,
              base: routes.especialidadesList,
              permision: 'appointments_especialidades_list',
              show_nav: true,
            },
            {
              menuValue: 'ADD',
              route: routes.addEspecialidad,
              base: routes.addEspecialidad,
              permision: 'appointments_add_especialidad',
              show_nav: true,
            },
            {
              menuValue: 'EDIT',
              route: '',
              base: '',
              permision: 'appointments_edit_especialidad',
              show_nav: false,
            },
            {
              menuValue: 'DELETE',
              route: '',
              base: '',
              permision: 'appointments_delete_especialidad',
              show_nav: false,
            },
          ],
        },
        {
          menuValue: 'GENERAL_MEDICAL',
          group: 'GRUPO_CITAS',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'appointments',
          ...
          subMenus: [
            {
              menuValue: 'LIST',
              route: routes.generalMedicalsList,
              base: routes.generalMedicalsList,
              permision: 'appointments_list_general_medical',
              show_nav: true,
            },
            {
              menuValue: 'ADD',
              route: routes.addGeneralMedical,
              base: routes.addGeneralMedical,
              permision: 'appointments_add_general_medical',
              show_nav: true,
            },
            {
              menuValue: 'EDIT',
              route: '',
              base: '',
              permision: 'appointments_edit_general_medical',
              show_nav: false,
            },
            {
              menuValue: 'DELETE',
              route: '',
              base: '',
              permision: 'appointments_delete_general_medical',
              show_nav: false,
            },
          ],
        },
